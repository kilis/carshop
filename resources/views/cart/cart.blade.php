                ...
                @foreach($items as $item)
                    <tr>
                        <td class="col-sm-8 col-md-6">
                            <div class="media">
                                <a class="thumbnail pull-left" href="#"> <img class="media-object" src="{{route('get_part_img', $item->product->file_id)}}" style="width: 100px; height: 72px;"> </a>
